...
public class Main {
    ...
    /**
     * The main entry point for the Westminster Shopping application. Allows
     * users to log in as an Admin or User and interact with the shopping
     * system.
     *
    ...
    /**
     * Helper method to ask the user if they want to continue as a certain role
     * (admin or user).
     *
     * @param input - Scanner object for user input.
     * @param role - The role (admin or user) for which the user is asked to
     * continue.
     * @return True if the user wants to continue as the given role, false if
     * they want to redirect to the main menu.
     */
